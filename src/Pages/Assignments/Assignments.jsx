                    ...
                    <tbody>
                        {/* row 1 */}
                        {
                            allAssignments.map(assignment => {
                                ...
                                return <tr key={author._id} className="hover">
                                    <td>{author}</td>
                                    <td>{title}</td>
                                    <td>{marks}</td>
                                    ...
                                    <td>
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <Link to={`/assignments/${_id}`} title="Edit" className="bg-[#e6ff74] p-2 rounded-sm cursor-pointer hover:bg-[#d7ff24] transition-all"><FaEdit /></Link>
